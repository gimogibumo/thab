...
watch([filter, selectedCategories], () => {
  listExpense()
}, { deep: true })
            ...
            <div v-else>
              ...
              <div class="d-flex align-items-center justify-content-between flex-wrap">
                ...
                <div class="col-md-3 text-end">
                  <div class="fw-bold">{{ item.amount.toLocaleString() }} JPY</div>
                  <div class="text-muted">{{ (item.amount * 10).toLocaleString() }}원</div>
                </div>
                ...
                <div class="col-md-3 text-end">
                  <div class="btn-group">
                    ...
                    <button class="btn btn-sm text-white" :style="{ backgroundColor: '#8B6F5C' }" @click="startEditing(item)">수정</button>
                    <button
                      class="btn btn-sm"
                      :style="{
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p><strong>금액:</strong> {{ modalData.amount.toLocaleString() }} JPY / {{ (modalData.amount * 10).toLocaleString() }}원</p>
